...
You can install weightedcorrs by running ```pip install git+https://github.com/gjpelletier/weightedcorrs.git``` in your notebook or terminal, or you can copy the code to your own project.
