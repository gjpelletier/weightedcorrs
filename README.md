...
Download weightedcorrs.m from MATLAB File Exchange or this github repository (https://github.com/gjpelletier/weightedcorrs) and add it to your working directory or session search path.<br>
